...
class DryRequestsCollectors_test extends TestCase {
	...
	public function testGETDryRequest(){
		...
		$ActualDryRequest = Talis\Extensions\TheKof\SurveyMonkey::surveys($fake_survey_id)->collectors()->get_dry();
	...
	public function testPOSTDryRequest(){
		...
		$ActualDryRequest = Talis\Extensions\TheKof\SurveyMonkey::surveys($fake_survey_id)->collectors()->post_dry($CollectorModel);
